...
/* Definitions for AK10_Calibratio */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, GPIO_PIN_3|ONBOARD_LED_YELLOWGREEN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PG3 ONBOARD_LED_YELLOWGREEN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_3|ONBOARD_LED_YELLOWGREEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);
...
/* USER CODE BEGIN Header_AK10Calibration */
/**
  * @brief  Function implementing the AK10_Calibratio thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_AK10Calibration */
void AK10Calibration(void *argument)
{
