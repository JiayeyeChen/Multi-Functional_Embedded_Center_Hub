...
{
	hexo->calGravLeftKnee = hexo->gravLeftCoef_2 * sinf(hexo->hMotorLeftKnee.realPosition.f + hexo->hMotorLeftHip.realPosition.f);
	hexo->calGravRightKnee = hexo->gravRightCoef_2 * sinf(hexo->hMotorRightKnee.realPosition.f + hexo->hMotorRightHip.realPosition.f);
	hexo->calGravLeftHip = hexo->calGravLeftKnee + hexo->gravLeftCoef_1 * sinf(hexo->hMotorLeftHip.realPosition.f);
	hexo->calGravRightHip = hexo->calGravRightKnee + hexo->gravRightCoef_1 * sinf(hexo->hMotorRightHip.realPosition.f);
}
